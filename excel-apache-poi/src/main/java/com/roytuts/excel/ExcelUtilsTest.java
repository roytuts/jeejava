...
public class ExcelUtilsTest {
	...
	public void testWriteToExcelInMultiSheets() {
		ExcelUtils.writeToExcelInMultiSheets("C:/workspace/excel.xlsx", "Person Details", persons);
		ExcelUtils.writeToExcelInMultiSheets("C:/workspace/excel.xlsx", "User Details", users);
		ExcelUtils.writeToExcelInMultiSheets("C:/workspace/excel.xlsx", "Contact Details", contacts);
	}
